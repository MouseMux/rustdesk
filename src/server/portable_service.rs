...
pub mod server {
    ...
    pub fn run_portable_service() {
        // MouseMux V2: no initialization needed here. The main process owns all
        // MouseMux protocol communication via its message window; this elevated
        // process only consumes the IDs synced to its Enigo instance over IPC.
